...
const EditEventScreen = ({ route, navigation }) => {
  const { eventId } = route.params; // Get the eventId passed through navigation
  ...
  const handleUpdateEvent = async () => {
    ...
    try {
        // Update event using updateEvent
      await updateEvent(eventId, name, date, location, category, description);
      // Navigate back after event saving
      navigation.goBack();
    } catch (error) {
